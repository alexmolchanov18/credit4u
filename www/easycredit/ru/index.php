...
<html lang="ru">
	...
	<body>
		...
		<footer>
			<div class="wrapper">
				<div class="policy_text">EasyCredit – это платформа с предложениями кредитных организаций. Мы не являемся финансовой организацией, банком или кредитором. Подсчеты носят приблизительный характер, окончательные условия уточняйте на сайте кредитной компании.</div>
		...
		<?php include_once($_SERVER["DOCUMENT_ROOT"]) .'/modals/modal-easycredit.php' ?>
