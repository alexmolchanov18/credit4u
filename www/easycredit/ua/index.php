...
<html lang="ua">
	<head>
		...
		<link rel="stylesheet" href="/css/style-easycredit.css">
	...
	<body>
		...
		<header>
			<div style="padding-bottom: 0;" class="wrapper">
				<div class="logo">Easy<span>Credit</span></div>
			</div>
		...
		<main>
			<div class="entry-content">
				...
				<a target="_blank" rel="nofollow noopener noreferrer" href="https://go.salesdoubler.net/in/offer/1986?aid=63223" class="offer red <?php $ar->displayHideClass(1986);?>">
					...
					<div class="details_block">
						<ul>
							<li><img src="/img/dollar.svg" alt="">На картку / Наличка</li>
				...
				<a target="_blank" rel="nofollow noopener noreferrer" href="https://go.salesdoubler.net/in/offer/1556?aid=63223" class="offer red">
						<div class="promo_offer_block">0% на 30 дней!</div>
						<div class="offer_logo"><img src="/img/cashinky.png" alt=""></div>
						<div class="offer_info_wrap">
								<div class="offer_info">
										<div class="offer_info_title">Сума:</div>
										<div class="offer_info_description">10 000 грн.</div>
				...
				<!-- <a target="_blank" rel="nofollow noopener noreferrer" href="https://go.salesdoubler.net/in/offer/1710?aid=63223" class="offer red">
						<div class="promo_offer_block">Рекомендуємо!</div>
						<div class="offer_logo"><img src="/img/kachay.png" alt=""></div>
						<div class="offer_info_wrap">
								<div class="offer_info">
										<div class="offer_info_title">Сума:</div>
										<div class="offer_info_description">15 000 грн.</div>
		...
		<footer>
			<div class="wrapper">
				<div class="policy_text">EasyCredit – це платформа з пропозиціями кредитних організацій. Ми не є фінансовою організацією, банком чи кредитором. Підрахунки носять приблизний характер, остаточні умови уточнюйте на сайті кредитної компанії.</div>
		...
		<?php include_once($_SERVER["DOCUMENT_ROOT"]) .'/uaModals/modal-easycredit.php' ?>
