<!-- <?php require_once ($_SERVER["DOCUMENT_ROOT"]) .'/creditonline/offers_api/OffersAPI.php'; ?> -->
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<section class="top_descr" style="">
			...
			<div class="wrapper">
				<h1>Вам одобрен кредит в следующих компаниях</h1>
				<p>Для 100% одобрения отправьте 3-4 заявки и получите лучшие условия кредита</p>
			</div>
		</section>
		<main>
			<div class="wrapper">
				...
				<div class="entry-content">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/2099?aid=63223">
						<div class="creditOffer ">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Credit7</h2>
								<h2 class="credit_descr green_credit">Первый кредит до 8 000 гривен под 0,01% в день</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/2217?aid=63223">
						<div class="creditOffer">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Money4u</h2>
							...
							<div class="details_wrap">
								...
								<div class="details">
									<div class="credit_bet_descr">максимальная сумма</div>
									<div class="credit_bet">до <span>12 000</span>₴</div>
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/1914?aid=63223">
						<div class="creditOffer">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Monetka</h2>
								<h2 class="credit_descr green_credit">Первый кредит под 0%</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/1261?aid=63223">
						<div class="creditOffer ">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от MyCredit</h2>
								<h2 class="credit_descr green_credit">Первый кредит до 8 000 гривен под 0,01% в день</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/1985?aid=63223">
						<div class="creditOffer">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Groshik</h2>
								<h2 class="credit_descr green_credit">Получите до 3000 грн со 100% * скидкой на свой первый кредит!</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<!-- <a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/2591?aid=63223">
						<div class="creditOffer">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Cly</h2>
								<h2 class="credit_descr green_credit">Получите до 3000 грн со 100% * скидкой на свой первый кредит!</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/1704?aid=63223">
						<div class="creditOffer ">
							<div class="logo_and_desc">
								<div class="credit_image"><img src="/img/logo_creditkasa.jpg" alt=""></div>
								<h2 class="credit_descr">Кредит онлайн от KreditKasa</h2>
								<h2 class="credit_descr green_credit">Первый кредит до 8 000 гривен под 0,01% в день</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
					...
					<a rel="nofollow noopener noreferrer" class="" target="_blank" href="https://go.salesdoubler.net/in/offer/1712?aid=63223">
						<div class="creditOffer">
							<div class="logo_and_desc">
								...
								<h2 class="credit_descr">Кредит онлайн от Mazila</h2>
								<h2 class="credit_descr green_credit">Первый кредит под 0%</h2>
							</div>
							<div class="details_wrap">
								<div class="details">
		...
		<footer>
			<div class="wrapper">
				<div class="policy_text">«CreditOnline» – это платформа с предложениями кредитных организаций. Мы не являемся финансовой организацией, банком или кредитором. Подсчеты носят приблизительный характер, окончательные условия уточняйте на сайте кредитной компании.</div>
			</div>
		</footer>
